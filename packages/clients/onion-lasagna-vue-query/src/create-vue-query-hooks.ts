/**
 * @fileoverview Factory for creating Vue Query hooks from router definitions.
 *
...
import type { VueQueryHooksResult, VueQueryHooksConfig, InferHooks, InferQueryKeys } from './types';
...
/**
 * Creates Vue Query hooks from a router definition.
 *
 ...
 * ```
 */
export function createVueQueryHooks<T extends RouterConfig>(
  router: T | RouterDefinition<T>,
  config: VueQueryHooksConfig,
): VueQueryHooksResult<T> {
